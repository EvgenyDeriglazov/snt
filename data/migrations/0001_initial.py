# Generated by Django 3.0.2 on 2020-02-16 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t1_new', models.PositiveIntegerField(help_text='Тариф Т1 (6:00-23:00)', verbose_name='Текущее показание (день)')),
                ...
                ('record_status', models.CharField(choices=[('n', 'Новые показания'), ('p', 'Оплачено'), ('c', 'Оплата подтверждена'), ('i', 'Первые показания')], default='n', help_text='Статус показаний', max_length=1, verbose_name='Статус')),
