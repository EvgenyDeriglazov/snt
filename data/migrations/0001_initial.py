# Generated by Django 3.0.2 on 2020-03-09 06:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('t1_rate', models.DecimalField(decimal_places=2, help_text='Тариф Т1 (6:00-23:00)', max_digits=4, verbose_name='Тариф день')),
                ('t2_rate', models.DecimalField(decimal_places=2, help_text='Тариф Т2 (23:00-6:00)', max_digits=4, verbose_name='Тариф ночь')),
                ('t_single_rate', models.DecimalField(decimal_places=2, help_text='Однотарифный', max_digits=4, verbose_name='Однотарифный')),
