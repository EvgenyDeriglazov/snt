    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_status', models.CharField(blank=True, choices=[('c', 'Действующий')], default='c', max_length=1, null=True, unique=True, verbose_name='Вид тарифа')),
            ],
            options={
                'verbose_name': 'Тариф',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_status', models.CharField(choices=[('n', 'Новые показания'), ('p', 'Оплачено'), ('c', 'Оплата подтверждена'), ('o', 'Оплачено ранее')], default='n', help_text='Статус показаний', max_length=1, verbose_name='Статус')),
